...
public class MyMouseAdapter extends MouseAdapter 
 {
	...
	int counter = 10;
	public static MineLocations mines = new MineLocations(10);
			...
			if(gridX >= 0 && gridX <= 8 && gridY >= 0 && gridY <= 8)
			 {
				...
				else if(!mines.Coordinate_Compare(gridX, gridY))
				 {
				...
				if(mines.Coordinate_Compare(gridX, gridY))
				 {
